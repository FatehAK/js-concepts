...
debounceInput.addEventListener('keyup', _.debounce(function(evt) {
...
dbutton.addEventListener('click', _.debounce(function() {
...
tContainer.addEventListener('scroll', _.throttle(function() {
    console.log('called');
...
tbutton.addEventListener('click', _.throttle(function() {
