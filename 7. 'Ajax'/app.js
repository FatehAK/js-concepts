...
btn6.addEventListener('click', function() {
    ...
    xhr.setRequestHeader('Authorization', 'Client-ID a3e6e71b17149e753e6500c706f5c159b27096a953c8d92028635486f85606d7');
...
btn7.addEventListener('click', function() {
    ...
    xhr.open('get', `https://api.nytimes.com/svc/search/v2/articlesearch.json?q=${searchText}&api-key=gGUmDAUD9aMtxw0OPvodWVMlAmIQT1uq`);
...
btn8.addEventListener('click', function() {
    const originalText = prompt('Translate from English <--> Italian?', 'This is asynchronous programming');
    ...
    $.ajax({
        ...
        // }
    }).done(addTranslate).fail(function(e) {
